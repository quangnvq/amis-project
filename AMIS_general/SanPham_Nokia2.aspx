...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="302px" ImageUrl="~/Image/nokia 230.PNG" style="margin-top: 0px" Width="277px" PostBackUrl="~/ChiTietSanPham/Nokia230.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="291px" ImageUrl="~/Image/nokia 150.PNG" style="margin-top: 0px" Width="278px" PostBackUrl="~/ChiTietSanPham/NokiaN150.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="308px" ImageUrl="~/Image/nokia 105.PNG" style="margin-top: 0px" Width="269px" PostBackUrl="~/ChiTietSanPham/Nokia105 SS.aspx" />
                <br />
