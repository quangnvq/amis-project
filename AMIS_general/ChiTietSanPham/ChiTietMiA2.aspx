<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietMiA2.aspx.cs" Inherits="ChiTietSanPham_ChiTietMiA2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="37px" ImageUrl="~/Image/tragop.PNG" Width="98px" />
        </span></span>
    </p>
    <p>
        <asp:Image ID="Image3" runat="server" Height="326px" ImageUrl="~/Image/xiaomi/xiaomi-mi-9-se-blue-18thangbh-600x600.jpg" Width="555px" />
    </p>
    <p>
