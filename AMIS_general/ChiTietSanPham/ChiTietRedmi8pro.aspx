<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietRedmi8pro.aspx.cs" Inherits="ChiTietSanPham_ChiTietRedmi8pro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <p class="auto-style91">
        Điện thoại Xiaomi Redmi Note 8 Pro</p>
    <p>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Image/redmi note 8 pro.PNG" Height="458px" Width="293px" />
    </p>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="36px" ImageUrl="~/Image/tragop.PNG" Width="118px" />
        </span></span>
    </p>
    <p>
