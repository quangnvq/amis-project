<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChitietMi9.aspx.cs" Inherits="ChiTietSanPham_ChitietMi9" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="33px" ImageUrl="~/Image/tragop.PNG" Width="105px" />
        </span></span>
    </p>
    <p>
