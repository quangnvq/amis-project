<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietSSA20.aspx.cs" Inherits="ChiTietSanPham_ChiTietSSA20" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="42px" ImageUrl="~/Image/tragop.PNG" Width="112px" />
        </span></span>
    </p>
    <p>
