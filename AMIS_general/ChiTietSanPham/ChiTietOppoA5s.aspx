<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietOppoA5s.aspx.cs" Inherits="ChiTietSanPham_ChiTietOppoA5s" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="37px" ImageUrl="~/Image/tragop.PNG" Width="102px" />
        </span></span>
    </p>
    <p>
        <asp:Image ID="Image3" runat="server" Height="326px" ImageUrl="~/Image/oppo-a5s-red-400x400.jpg" Width="555px" />
    </p>
    <p>
