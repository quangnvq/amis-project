<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="iPhoneXr.aspx.cs" Inherits="ChiTietSanPham_iPhoneXr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton4" runat="server" Height="333px" ImageUrl="~/Image/ip xr.PNG" style="margin-top: 0px" Width="246px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">iPhone Xr 128GB<br /><span class="auto-style89">NGỪNG KINH DOANH</span></span></span><br /></td>
        </tr>
    </table>
</asp:Content>
