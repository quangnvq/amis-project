<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="Nokia3.2.aspx.cs" Inherits="ChiTietSanPham_Nokia3_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton4" runat="server" Height="308px" ImageUrl="~/Image/nokia 3.2.PNG" style="margin-top: 0px" Width="252px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">Nokia 3.2 32GB<br /></span></span><span class="auto-style86"><span class="auto-style89">NGỪNG KINH DOANH</span></span></td>
        </tr>
    </table>
</asp:Content>
