<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietMi6.aspx.cs" Inherits="ChiTietSanPham_ChiTietMi6" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="33px" ImageUrl="~/Image/tragop.PNG" Width="104px" />
        </span></span>
    </p>
    <p>
