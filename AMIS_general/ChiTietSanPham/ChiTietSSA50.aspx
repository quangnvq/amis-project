<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietSSA50.aspx.cs" Inherits="ChiTietSanPham_ChiTietSSA50" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="36px" ImageUrl="~/Image/tragop.PNG" Width="107px" />
        </span></span>
    </p>
    <p>
