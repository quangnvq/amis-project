<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="iPhone8.aspx.cs" Inherits="ChiTietSanPham_iPhone8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton5" runat="server" Height="333px" ImageUrl="~/Image/ip 8.PNG" style="margin-top: 0px" Width="233px" PostBackUrl="~/ChiTietSanPham/iPhone8.aspx" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">iPhone 8 64G<br /><span class="auto-style89">14.490.000<span class="auto-style90">đ</span></span></span></span></td>
        </tr>
    </table>
                <br />
                </asp:Content>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btn_iphone12" runat="server" CssClass="auto-style80" Text="Ngừng kinh doanh" />
    <br />
    <br />
    <br />
    <br />
