<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="Realme 3 Pro.aspx.cs" Inherits="ChiTietSanPham_Realme_3_Pro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="307px" ImageUrl="~/Image/realme 3 pro.PNG" style="margin-top: 0px" Width="247px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">Realme 3 Pro (4GB/64GB)<br /><span class="auto-style89">4.790.000<span class="auto-style90">đ</span></span></span></span></td>
        </tr>
    </table>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="area_promotion   zero " style="margin: 5px 10px 12px; padding: 0px 0px 10px; display: block; overflow: hidden; border: 1px solid rgb(221, 221, 221); border-radius: 4px; position: relative; background: rgb(255, 255, 255); color: rgb(51, 51, 51); font-family: Helvetica, Arial, &quot;DejaVu Sans&quot;, &quot;Liberation Sans&quot;, Freesans, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial;">
        <strong data-count="1" style="margin: 0px; padding: 15px 15px 10px; display: block; overflow: hidden; font-size: 15px; color: rgb(51, 51, 51); text-transform: uppercase;">KHUYẾN MÃI</strong><div class="infopr" style="margin: 0px; padding: 0px;">
            ...
            <label style="margin: 0px; padding: 0px; font: 14px/18px Helvetica, Arial, &quot;DejaVu Sans&quot;, &quot;Liberation Sans&quot;, Freesans, sans-serif; outline: none; zoom: 1;" class="auto-style92">
            Giảm thêm 5% (300.000₫) cho khách mua online</label><span>&nbsp;</span></span></div>
        <div class="infopr" style="margin: 0px; padding: 0px;">
            <span class="pro534294 " data-date="11/30/2019 11:00:00 PM" data-fromvalue="0" data-g="Tặng" data-return="" data-tovalue="1000000" style="margin: 0px; padding: 0px 15px 5px 40px; display: block; overflow: hidden; font-size: 14px; color: rgb(51, 51, 51);">Giảm ngay 1 triệu (đã trừ vào giá)</span></div>
        <div class="clr" style="margin: 0px; padding: 0px; clear: both;">
        </div>
        <div class="auto-style92" style="margin: 5px 0px 0px; padding: 5px 10px; font-size: 14px;">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br />
    <br />
                <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/SanPham_Realme.aspx">Quay lại</asp:HyperLink>
            </asp:Content>
