<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietSSA30.aspx.cs" Inherits="ChiTietSanPham_ChiTietSSA30" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <p class="auto-style91">
        Điện thoại Samsung Galaxy A30s</p>
    <p>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Image/ss a30s.PNG" />
    </p>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="37px" ImageUrl="~/Image/tragop.PNG" Width="120px" />
        </span></span>
    </p>
    <p>
        <asp:Image ID="Image3" runat="server" Height="326px" ImageUrl="~/Image/KMSS.PNG" Width="555px" />
    </p>
    <p>
