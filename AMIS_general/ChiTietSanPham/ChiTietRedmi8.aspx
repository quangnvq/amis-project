<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietRedmi8.aspx.cs" Inherits="ChiTietSanPham_ChiTietRedmi8" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Image ID="Image2" runat="server" Height="39px" ImageUrl="~/Image/tragop.PNG" Width="112px" />
        </span></span>
    </p>
    <p>
        <asp:Image ID="Image3" runat="server" Height="326px" ImageUrl="~/Image/KMMi8.PNG" Width="555px" />
    </p>
    <br />
