<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="ChiTietOppoReno.aspx.cs" Inherits="ChiTietSanPham_ChiTietOppoReno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <p class="auto-style47">
        Điện thoại Oppo Reno</p>
    <p>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Image/oppo reno.PNG" />
    </p>
    <p>
        &nbsp;</p>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="auto-style91">
        <span class="auto-style47">9.990.000</span><span class="auto-style90"><span class="auto-style47">đ&nbsp;</span>&nbsp;
        <asp:Image ID="Image2" runat="server" Height="42px" ImageUrl="~/Image/tragop.PNG" Width="105px" />
        </span>
    </p>
    <p>
        &nbsp;</p>
    <p>
        <asp:Image ID="Image3" runat="server" Height="326px" ImageUrl="~/Image/KMoppo.PNG" Width="555px" />
    </p>
    <br />
