<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="Nokia7.2.aspx.cs" Inherits="ChiTietSanPham_Nokia7_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/nokia 7.2.PNG" style="margin-top: 5px" Width="251px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">Nokia 7.2<br /></span></span><span class="auto-style86"><span class="auto-style89">NGỪNG KINH DOANH</span></span></td>
        </tr>
    </table>
</asp:Content>
