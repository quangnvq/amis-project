<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.master" AutoEventWireup="true" CodeFile="iPhone11.aspx.cs" Inherits="ChiTietSanPham_iPhone11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="330px" ImageUrl="~/Image/ip 11.PNG" style="margin-top: 13px" Width="245px" />
                </td>
        </tr>
        <tr>
            <td class="auto-style3">
                <span class="auto-style84"><span class="auto-style86">iPhone 11 128GB<br /><span class="auto-style89">NGỪNG KINH DOANH</span></span></span></td>
        </tr>
    </table>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        <span class="auto-style84"><span class="auto-style86"><span class="auto-style89">NGỪNG KINH DOANH</span></span></span></p>
    <p>
                <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/SanPham_Apple2.aspx">Quay lại</asp:HyperLink>
            </p>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <ul class="parameter " style="margin: 0px; padding: 10px 0px 0px; list-style: none; display: block; position: relative; overflow: hidden; background: rgb(255, 255, 255); color: rgb(51, 51, 51); font-family: Helvetica, Arial, &quot;DejaVu Sans&quot;, &quot;Liberation Sans&quot;, Freesans, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial; top: 0px; left: 1px; width: 356px;">
        ...
        <li class="g6339_6463" style="margin: 0px; padding: 5px 0px; display: table; background: rgb(255, 255, 255); width: 360px; border-top: 1px solid rgb(238, 238, 238);"><span style="margin: 0px; padding: 5px 0px; display: table-cell; width: 144px; vertical-align: top; font-size: 14px; color: rgb(102, 102, 102);">Thẻ SIM:</span><div class="isim" style="margin: 0px; padding: 6px 5px; display: block; width: auto; vertical-align: top; font-size: 14px; color: rgb(51, 51, 51); border-bottom: 1px solid rgb(238, 238, 238);">
            <a href="https://www.thegioididong.com/hoi-dap/esim-la-gi-esim-co-su-dung-duoc-o-viet-nam-khong-1118062" style="margin: 0px; padding: 0px; text-decoration: none; color: rgb(40, 138, 214);" target="_blank">Nano SIM &amp; eSIM</a>,<span>&nbsp;</span><a href="https://www.thegioididong.com/hoi-dap/4g-la-gi-731757" style="margin: 0px; padding: 0px; text-decoration: none; color: rgb(40, 138, 214);" target="_blank">Hỗ trợ 4G</a></div>
