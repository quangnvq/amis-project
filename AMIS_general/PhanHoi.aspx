...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        <tr>
            <td class="auto-style51">Loại Phản Hồi</td>
            <td id="ddl_LPH">
                <asp:DropDownList runat="server" DataTextField="CategoryFeedbacksName" DataValueField="CategoryFeedbacksName">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="auto-style51">Tên Khách Hàng</td>
            <td>
        ...
        <tr>
            <td class="auto-style48" colspan="2"><span class="auto-style50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</span><asp:Button ID="Button2" runat="server" Text="Gửi" />
            </td>
        </tr>
    </table>
</asp:Content>
