...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        <tr>
            <td class="auto-style97" colspan="4"><span class="auto-style99">Điện thoại Apple</span><br class="auto-style92" /></td>
        </tr>
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="333px" ImageUrl="~/Image/iphone/iphone-7-plus-black-600x600.jpg" style="margin-top: 0px" Width="246px" PostBackUrl="~/ChiTietSanPham/iPhoneX.aspx" />
                <br /><span class="auto-style84"><span class="auto-style86">iPhone X 64G<br /><span class="auto-style89">19.490.000<span class="auto-style90">đ</span></span></span></span><br />
                <br />Màn hình: 5.8&quot;, Super Retina<br />HĐH: iOS 12<br />CPU: Apple A11 Bionic 6 nhân<br />RAM: 3GB, ROM: 64GB<br />Camera: Chính 12MP &amp; Phụ 12MP,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selfie: 7 MP<br />PIN: 2716 mAh<br />
                <br />
                <br />
                <br />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                ...
                <br /><span class="auto-style84"><span class="auto-style86">iPhone 8 Plus 64G<br /><span class="auto-style89">15.990.000<span class="auto-style90">đ</span></span></span></span><br />&nbsp;<br />Màn hình: 5.5&quot;, Retina HD<br />HĐH: iOS 12<br />CPU: Apple A11 Bionic 6 nhân<br />RAM: 3GB, ROM: 64GB<br />Camera: Chính 12MP &amp; Phụ 12MP,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selfie: 7 MP<br />PIN: 2691 mAh<br />
                <br />
                <br />
                <br />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton5" runat="server" Height="333px" ImageUrl="~/Image/iphone/iphone-7-plus-black-600x600.jpg" style="margin-top: 0px" Width="233px" PostBackUrl="~/ChiTietSanPham/iPhone8.aspx" />
                <br /><span class="auto-style84"><span class="auto-style86">iPhone 8 64G<br /><span class="auto-style89">14.490.000<span class="auto-style90">đ</span></span></span></span><br />&nbsp;<br /><span class="auto-style98">Màn hình: 4,7&quot;, Retina HD<br />HĐH: iOS 12<br />CPU: Apple A11 Bionic 6 nhân<br />RAM: 3GB, ROM: 64GB<br />Camera: Chính 12MP &amp; Phụ 12MP,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selfie: 7 MP<br />PIN: 2691 mAh<br />
                <br />
                <br />
                <br />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop3" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style91">
                ...
                <br /><span class="auto-style84"><span class="auto-style86">iPhone 7 Plus 32G<br /></span></span><span class="auto-style86"><span class="auto-style89">11.990.000<span class="auto-style90">đ</span></span></span><br />&nbsp;<br />Màn hình: 5.5&quot;, Retina HD<br />HĐH: iOS 12<br />CPU: Apple A10 Fusion 4 nhân<br />RAM: 3GB, ROM: 32GB<br />Camera: Chính 12MP &amp; Phụ 12MP,<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selfie: 7 MP<br />PIN: 2900 mAh<br />
                <br />
                <br />
                <br />
                <br />
