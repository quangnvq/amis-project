...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="338px" ImageUrl="~/Image/xiaomi/xiaomi-redmi-go-16gb-blue-18thangbh-600x600.jpg" style="margin-top: 0px" Width="306px" PostBackUrl="~/ChiTietSanPham/ChiTietMiA2.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
                <br /></td>
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="330px" ImageUrl="~/Image/xiaomi/xiaomi-mi-a3-white-18thangbh-600x600.jpg" style="margin-top: 0px" Width="281px" />
...
&nbsp;</td>
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="326px" ImageUrl="~/Image/xiaomi/xiaomi-mi-9t-red-18thangbh-600x600.jpg" style="margin-top: 0px" Width="284px" />
