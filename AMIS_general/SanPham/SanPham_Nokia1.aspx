...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="291px" ImageUrl="~/Image/Nokia/nokia-81-blue-18thangbh-600x600.jpg" style="margin-top: 0px" Width="250px" PostBackUrl="~/ChiTietSanPham/Nokia8.1.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="291px" ImageUrl="~/Image/Nokia/nokia-61-plus-2-600x600.jpg" style="margin-top: 0px" Width="253px" PostBackUrl="~/ChiTietSanPham/Nokia6.1Plus.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/Nokia/nokia-72-black-600x600.jpg" style="margin-top: 5px" Width="262px" PostBackUrl="~/ChiTietSanPham/Nokia7.2.aspx" />
                <br />
...
&nbsp;</td>
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="308px" ImageUrl="~/Image/Nokia/nokia-32-16gb-2-600x600.jpg" style="margin-top: 0px" Width="269px" PostBackUrl="~/ChiTietSanPham/Nokia3.2.aspx" />
                <br />
