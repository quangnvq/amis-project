...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="333px" ImageUrl="~/Image/ip X.PNG" style="margin-top: 0px" Width="246px" PostBackUrl="~/ChiTietSanPham/iPhone6S.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/GioHang.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="330px" ImageUrl="~/Image/ip 11.PNG" style="margin-top: 13px" Width="245px" PostBackUrl="~/ChiTietSanPham/iPhone11.aspx" />
                <br />
...
&nbsp;</td>
            <td class="auto-style93">
                <br />
                <asp:ImageButton ID="ImageButton5" runat="server" Height="331px" ImageUrl="~/Image/ip xs.PNG" style="margin-top: 13px" Width="240px" PostBackUrl="~/ChiTietSanPham/iPhoneXs.aspx" />
                <br />
...
&nbsp;</span></td>
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="333px" ImageUrl="~/Image/ip xr.PNG" style="margin-top: 0px" Width="246px" PostBackUrl="~/ChiTietSanPham/iPhoneXr.aspx" />
                <br />
...
&nbsp;</td>
        ...
        <tr>
            <td class="auto-style3" colspan="4" style="text-align: center">
                <asp:HyperLink ID="hpl_ss1" runat="server" NavigateUrl="~/SanPham_Apple1.aspx">1</asp:HyperLink>
&nbsp;<asp:HyperLink ID="hpl_ss2" runat="server" NavigateUrl="~/SanPham_Apple2.aspx">2</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
