...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <span class="auto-style92">&nbsp;sản phẩm</span></span><br />
    <br /><span class="auto-style44">Điện thoại</span><br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="291px" ImageUrl="~/Image/ss j7.PNG" style="margin-top: 38px" Width="250px" PostBackUrl="~/ChiTietSanPham/ChiTietSSJ7.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="289px" ImageUrl="~/Image/ss s10.PNG" style="margin-top: 45px" Width="239px" />
                <br />
...
&nbsp;</td>
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/ss a10.PNG" style="margin-top: 0px" Width="252px" />
                <br />
