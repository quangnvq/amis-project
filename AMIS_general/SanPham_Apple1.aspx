...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="330px" ImageUrl="~/Image/ip 8 plus.PNG" style="margin-top: 0px" Width="245px" PostBackUrl="~/ChiTietSanPham/iPhone 8 Plus.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop3" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="333px" ImageUrl="~/Image/ip 7 plus.PNG" style="margin-top: 0px" Width="246px" PostBackUrl="~/ChiTietSanPham/iPhone7Plus32.aspx" />
                <br />
