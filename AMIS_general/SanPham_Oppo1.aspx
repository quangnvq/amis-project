...
&nbsp;sản phẩm</span><br class="auto-style96" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="291px" ImageUrl="~/Image/oppo reno.PNG" style="margin-top: 0px" Width="250px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoReno.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="291px" ImageUrl="~/Image/oppo f11 pro.PNG" style="margin-top: 0px" Width="253px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoF11.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/oppo a9.PNG" style="margin-top: 5px" Width="262px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoA9.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop1" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="308px" ImageUrl="~/Image/oppo a7.PNG" style="margin-top: 0px" Width="269px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoA7.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop2" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
        ...
        <tr>
            <td class="auto-style3" colspan="4" style="text-align: center">
                <asp:HyperLink ID="hpl_ss1" runat="server" NavigateUrl="~/SanPham_Oppo1.aspx">1</asp:HyperLink>
&nbsp;<asp:HyperLink ID="hpl_ss2" runat="server" NavigateUrl="~/SanPham_Oppo2.aspx">2</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
