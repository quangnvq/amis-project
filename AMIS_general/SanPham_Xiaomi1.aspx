...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="338px" ImageUrl="~/Image/mi 9.PNG" style="margin-top: 0px" Width="257px" PostBackUrl="~/ChiTietSanPham/ChitietMi9.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
                <br /></td>
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="330px" ImageUrl="~/Image/redmi note 8 pro.PNG" style="margin-top: 0px" Width="226px" PostBackUrl="~/ChiTietSanPham/ChiTietRedmi8pro.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="326px" ImageUrl="~/Image/redmi note 8.PNG" style="margin-top: 0px" Width="256px" PostBackUrl="~/ChiTietSanPham/ChiTietRedmi8.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop1" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="326px" ImageUrl="~/Image/mi 6.PNG" style="margin-top: 0px" Width="269px" PostBackUrl="~/ChiTietSanPham/ChiTietMi6.aspx" />
