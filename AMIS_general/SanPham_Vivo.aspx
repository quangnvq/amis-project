...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="291px" ImageUrl="~/Image/vivo y17.PNG" style="margin-top: 0px" Width="250px" PostBackUrl="~/ChiTietSanPham/ChiTietVivoY17.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="291px" ImageUrl="~/Image/vivo v15.PNG" style="margin-top: 0px" Width="253px" PostBackUrl="~/ChiTietSanPham/ChiTietVivoV15.aspx" />
                <br />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/vivo s1.PNG" style="margin-top: 5px" Width="262px" />
                <br />
