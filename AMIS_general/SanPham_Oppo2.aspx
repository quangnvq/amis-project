...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style47">
        ...
        <tr>
            <td>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="291px" ImageUrl="~/Image/opp0 a5s.PNG" style="margin-top: 0px" Width="250px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoA5s.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
                <br /></td>
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="291px" ImageUrl="~/Image/oppo a1k.PNG" style="margin-top: 0px" Width="253px" PostBackUrl="~/ChiTietSanPham/ChiTietOppoA1k.aspx" />
...
&nbsp;<asp:Button ID="btn_MuaTraGop0" runat="server" PostBackUrl="~/MuaTraGop.aspx" style="color: #FF0000" Text="Mua trả góp" />
            ...
            <td class="auto-style93">
                <asp:ImageButton ID="ImageButton3" runat="server" Height="290px" ImageUrl="~/Image/oppo f9.PNG" style="margin-top: 0px" Width="262px" />
...
&nbsp;</td>
            <td class="auto-style91">
                <asp:ImageButton ID="ImageButton4" runat="server" Height="290px" ImageUrl="~/Image/oppo k3.PNG" style="margin-top: 0px" Width="269px" />
